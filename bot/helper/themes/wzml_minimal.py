...
class WZMLStyle:
    ...
    ST_BN1_NAME = 'Owner'
    ST_BN1_URL = 'https://t.me/The_resist'
    ST_BN2_NAME = 'Mirror Group'
    ST_BN2_URL = 'https://t.me/mirrordownloader'
    ST_MSG = '''<i>This bot can mirror all your links, files, torrents to Google Drive or any rclone cloud or to telegram or to ddl servers.</b>'''
    ST_BOTPM = '''<i>Now, This bot will send all your files and links here. Start Using ...</i>'''
    ST_UNAUTH = '''<i>You Are not authorized user! You can use bot in our mirror group</i>'''
...
<b>Validity:</b> {validity}'''
    ...
    BOT_STATS = '''⌬ <b><i>BOT KI ओकाद (STATS) :</i></b>
┖ <b>BOT KITNA JINDA RAHA :</b> {bot_uptime}
...
⌬ <b>REMARKS :</b> <code>{remarks}</code>
    '''
    BOT_LIMITS = '''⌬ <b><i>BOT LIMITATIONS (LOOT LO) :</i></b>
